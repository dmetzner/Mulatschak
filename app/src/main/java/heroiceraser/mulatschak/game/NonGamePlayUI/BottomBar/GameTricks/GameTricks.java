package heroiceraser.mulatschak.game.NonGamePlayUI.BottomBar.GameTricks;
...
public class GameTricks extends ButtonBarWindow {
    ...
    public void init(@NonNull GameView view) {
        ...
        int info_text_size = layout.getLengthOnVerticalGrid(37);
        ...
        info_pos.y += layout.getLengthOnVerticalGrid(125);
        Point info_max_size = new Point(layout.getButtonBarWindowTricksSubtitleMaxSize());
        info_max_size.y += layout.getLengthOnVerticalGrid(87);
        ...
        // subtitle
        int subtitle_text_size = layout.getLengthOnVerticalGrid(50);
