...
public class AnimationSpeedGameMenu {
    ...
    public void init(GameController controller) {
        ...
        for (MyRadioButton rb : radioButtonGroup.getRadioButtons()) {
            rb.setRadius(layout.getLengthOnVerticalGrid(15));
        ...
        int x2 = (int) (x_p * 60);
        int x3 = (int) (x_p * 80);
        int y = layout.getLengthOnVerticalGrid(562);
        ...
        // init title
        title.setPosition(new Point((int) (x_p * 50), layout.getLengthOnVerticalGrid(462)));
        ...
        title.getTextPaint().setTextSize(layout.getLengthOnVerticalGrid(42));
